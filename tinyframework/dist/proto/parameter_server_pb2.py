...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[comm__pb2.DESCRIPTOR,])
...
_PARAMETERPUSHREQ.fields_by_name['node_gradients'].message_type = comm__pb2._NODEGRADIENTS
_PARAMETERPULLREQ.fields_by_name['nodes'].message_type = comm__pb2._NODE
_PARAMETERPULLRESP.fields_by_name['node_gradients'].message_type = comm__pb2._NODEGRADIENTS
...
_PARAMETERSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    input_type=comm__pb2._VARIABLEWEIGHTSREQRESP,
    output_type=comm__pb2._VARIABLEWEIGHTSREQRESP,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
